    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 text-xs text-text-secondary flex-wrap">
        ...
        <span className="text-accent-red">
          Despesas: R$ {Math.abs(filtered.filter((t) => countsInTotals(t, categories) && isExpenseAmount(t)).reduce((s, t) => s + t.amount, 0)).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
        </span>
